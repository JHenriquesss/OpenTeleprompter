...
| File | What |
|------|------|
| `01-architecture.md` | Layered architecture, animation rule, module boundaries, theme system |
...
| `04-decisions.md` | Decision log (rusqlite, Signal traits, wasm-bindgen, icon gen, theme, Ctrl+S, screenshots, release permissions, resume playback, per-script prefs) |
| `05-glossary.md` | Domain terms |
| `06-open-threads.md` | Carried threads across all phases, Phase 5 deferrals |

---
last-consolidated: 2026-06-07T06:05
sessions: 16 (prior 15 + phase-10-toast-wasm-tests)
